           ...
           <div class="container">  
               ...
               if($_GET){
                ...
                if($row=mysqli_query($link,$query)){
                    ...
                    $x=($date[1]+2);
                    echo "<span class='header'>Water Used on $y is<span style='color:blue;'> ".$array[$date[2]-1][$x]."ml</span></span>";
                }
                else{
               ...
               <h4 align="center">
               Report For The Whole Year</h4><br />
                <div class="table-responsive">  
                	<div class="col-md-12" align="right">
                    <!----- <form method="post">  
                          <input type="submit" name="generate_pdf" class="btn btn-success" value="Download Reports" />  
                     </form>  ----->
                     </div>
                     <br/>
                     <br/>
